...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Chatto",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6Chatto22BaseChatViewController")
@interface BaseChatViewController : UIViewController <UICollectionViewDataSource, UICollectionViewDelegate>
- (void)loadView;
- (void)viewDidLoad;
- (void)userDidTapOnCollectionView;
...
@interface BaseChatViewController (SWIFT_EXTENSION(Chatto))
...
- (BOOL)collectionView:(UICollectionView * _Nonnull)collectionView shouldShowMenuForItemAtIndexPath:(NSIndexPath * _Nullable)indexPath SWIFT_WARN_UNUSED_RESULT;
- (BOOL)collectionView:(UICollectionView * _Nonnull)collectionView canPerformAction:(SEL _Nonnull)action forItemAtIndexPath:(NSIndexPath * _Nullable)indexPath withSender:(id _Nullable)sender SWIFT_WARN_UNUSED_RESULT;
